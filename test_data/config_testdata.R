...
#
# Structure:
#   SECTION 1 — SITE SETTINGS  (test-data-specific values)
#   SECTION 2 — METHOD SETTINGS (same defaults as main config.R)
#   SECTION 3 — ADVANCED SETTINGS (same defaults as main config.R)
# =============================================================================
