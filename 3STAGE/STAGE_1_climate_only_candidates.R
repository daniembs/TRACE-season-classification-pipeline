...
#   for structural quality, and retain candidates for downstream climate-only
#   stress-testing and ranking.
#
...
#   Candidates are evaluated on four climate-structure metrics and screened
#   for incomplete assignment, insufficient class support, and missing levels.
#
# Inputs:
